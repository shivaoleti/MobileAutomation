...
public class Utils {
	...
	private static void loadConfigProp(String propertyFileName) throws IOException {
       // System.out.println("Saneesh "+System.getProperty("user.dir"));
	...
	private static DesiredCapabilities setCapabilities() throws IOException {
		...
		capabilities.setCapability("appPackage", "com.walmart.grocery");
		capabilities.setCapability("appActivity", "com.walmart.grocery.screen.start.StartupActivity");
		return capabilities;
	}
